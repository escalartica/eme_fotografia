...
export const featuredFrames: FeaturedFrame[] = [
  /* ABRE LA PREBODA DE CARMEN Y ALBERTO, no Maite y Nerea.
     ...
     El cambio es un INTERCAMBIO con la que cerraba la tira, y eso importa:
     las dos son verticales, así que el ritmo de formas de las once
     ...
     reordena todas las de detrás. La secuencia de orientaciones está fijada
     por prueba, precisamente por eso.
     Y abre una BODA. El primer intento puso aquí la preboda de Carmen y
     Alberto, que también es vertical y también resolvía la repetición, pero
     dejaba la cabecera del carrete de una web de bodas ocupada por una
     sesión que no es una boda. Ésta --el beso bajo el paraguas
     transparente-- lo es.
     Maite y Nerea sigue en el carrete --sacarla del sitio no podía costarle
     la boda--, ahora la última: lo más lejos posible de su propia portada. */
